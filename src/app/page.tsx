...
/** Contorno fino + highlight interno mínimo (sem halo externo) */
const edgeSurface =
  "border border-apex-accent/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.02)]";
      ...
      <section className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid items-center gap-8 md:grid-cols-2">
          <div className="flex flex-col gap-6">
            ...
            <button
              type="button"
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-apex-accent/20 bg-apex-accent px-6 py-4 text-base font-bold text-apex-bg shadow-[inset_0_1px_0_rgba(255,255,255,0.18)] transition-transform hover:scale-[1.02] sm:w-auto sm:px-8"
            >
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {ACTIVE_RAFFLES.map((raffle) => {
            ...
            return (
              <article
                key={raffle.id}
                className={`overflow-hidden rounded-xl bg-apex-surface ${edgeSurface} transition-all duration-300 hover:-translate-y-0.5 hover:border-apex-accent/30`}
              >
                <div className="relative flex aspect-video items-center justify-center border-b border-white/[0.04] bg-apex-bg">
                  <Icon
                    className="size-14 text-apex-accent/45 drop-shadow-[0_0_5px_rgba(0,212,255,0.05)]"
                    strokeWidth={1.5}
                    aria-hidden
                  />
                </div>
                <div className="p-5">
                  ...
                  <button
                    type="button"
                    className="mt-4 w-full rounded-lg border border-apex-accent/25 bg-apex-surface py-2.5 text-sm font-semibold text-apex-accent/90 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] transition-colors hover:border-apex-accent/45 hover:bg-apex-accent hover:text-apex-bg"
                  >
                    Participar
                  </button>
                </div>
